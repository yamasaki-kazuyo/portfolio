...
$refrom_name = "yamasaki kazuyo";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "お問い合わせを受け付けました";
...
<form class="form-post" action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" method="POST">
...
<div class="btn reset"><input type="button" value="前画面に戻る" onClick="history.back()"></p></div>
</div>
</form>
<?php } ?>
</div><!-- /formWrap -->
...
<div class="form-done">
 <h3>送信完了</h3>
 <p class="text1">送信ありがとうございました。<br/>送信は正常に完了しました。</p>
<a class="btn" href="http://yamasakikazuyo.sub.jp/portfolio/">トップページへ戻る</a>
</div>
<p class="copy">© Copyright 2021 Yamasaki Kazuyo.</p>
</body>
</html>
<?php 
